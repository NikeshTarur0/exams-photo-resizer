...
function resetControls(type) {
    ...
    let valId = type === 'photo' ? 'photoZoomVal' : 'sigZoomVal';
    if (type === 'passport') { zoomId = 'passportZoomRange'; valId = 'passportZoomVal'; }
    if (type === 'sigResizer') { zoomId = 'sigResizerZoomRange'; valId = 'sigResizerZoomVal'; }
    const zoomInput = document.getElementById(zoomId);
    if (zoomInput) zoomInput.value = 1;
    const valInput = document.getElementById(valId);
    if (valInput) valInput.textContent = '1.0x';
