...
const i18nDict = {
    en: {
        reset: "Reset", reviews: "Reviews (4.9⭐)", specsGuide: "Specs Guide",
        tabExamStudio: "Exam Resizer Studio", tabBgRemover: "BG Remover", tabCompressor: "Image Compressor",
        tabResizer: "Resize Images", tabConverter: "PNG ↔ JPG", tabCropper: "Crop Images",
        tabPdfToImage: "PDF to Image", tabUpscaler: "4K Upscaler", step1Label: "Step 1: Select Target Competitive Exam",
        chooseCountry: "1. Choose Country:", allCountries: "🌐 All Countries", indiaExams: "🇮🇳 India Exams", nepalExams: "🇳🇵 Nepal Exams", usaExams: "🇺🇸 USA & Global",
        filterCategory: "2. Filter by Category:", allCat: "All Categories", govJobs: "Government Jobs", civilServices: "Civil Services / PSC", banking: "Banking Exams", medical: "Medical Entrance", engineering: "Engineering Entrance",
        tabPhoto: "Passport Photograph", tabSig: "Signature Upload", btnRemoveBg: "Remove Background", btnDownloadBg: "Download Cleaned Image", btnDownloadComp: "Download Compressed Image", btnDownloadResize: "Download Resized Image", btnDownloadConv: "Download Converted File", btnDownloadCrop: "Download Cropped Image", btnDownloadUpscale: "Download 4K Image",
        footerHome: "Home", footerAbout: "About Us", footerReviews: "Reviews", footerPrivacy: "Privacy Policy", footerTerms: "Terms of Service", footerContact: "Contact Us"
    },
    hi: {
        reset: "रीसेट", reviews: "समीक्षाएं (4.9⭐)", specsGuide: "गाइड",
        tabExamStudio: "परीक्षा रिसाइज़र स्टूडियो", tabBgRemover: "बैकग्राउंड रिमूवर", tabCompressor: "इमेज कंप्रेसर",
        tabResizer: "इमेज रीसाइज़ करें", tabConverter: "PNG ↔ JPG", tabCropper: "इमेज क्रॉप करें",
        tabPdfToImage: "पीडीएफ से इमेज", tabUpscaler: "4K अपस्केलर", step1Label: "चरण 1: लक्ष्य परीक्षा चुनें",
        chooseCountry: "1. देश चुनें:", allCountries: "🌐 सभी देश", indiaExams: "🇮🇳 भारत परीक्षाएं", nepalExams: "🇳🇵 नेपाल परीक्षाएं", usaExams: "🇺🇸 यूएसए और वैश्विक",
        filterCategory: "2. श्रेणी के अनुसार फ़िल्टर करें:", allCat: "सभी श्रेणियां", govJobs: "सरकारी नौकरियां", civilServices: "सिविल सेवाएं / PSC", banking: "बैंकिंग परीक्षाएं", medical: "मेडिकल प्रवेश", engineering: "इंजीनियरिंग प्रवेश",
        tabPhoto: "पासपोर्ट फोटो", tabSig: "हस्ताक्षर अपलोड", btnRemoveBg: "बैकग्राउंड हटाएं", btnDownloadBg: "क्लीन फोटो डाउनलोड करें", btnDownloadComp: "कंप्रेस्ड फोटो डाउनलोड करें", btnDownloadResize: "रीसाइज़ फोटो डाउनलोड करें", btnDownloadConv: "कन्वर्ट फाइल डाउनलोड करें", btnDownloadCrop: "क्रॉप फोटो डाउनलोड करें", btnDownloadUpscale: "4K फोटो डाउनलोड करें",
        footerHome: "होम", footerAbout: "हमारे बारे में", footerReviews: "समीक्षाएं", footerPrivacy: "गोपनीयता नीति", footerTerms: "सेवा की शर्तें", footerContact: "संपर्क करें"
    },
    ne: {
        reset: "रिसेट", reviews: "समीक्षाहरू (4.9⭐)", specsGuide: "गाइड",
        tabExamStudio: "परीक्षा स्टुडियो", tabBgRemover: "ब्याकग्राउन्ड रिमूभर", tabCompressor: "इमेज कम्प्रेसर",
        tabResizer: "साइज परिवर्तन", tabConverter: "PNG ↔ JPG", tabCropper: "इमेज क्रप",
        tabPdfToImage: "पीडीएफ बाट फोटो", tabUpscaler: "4K अपस्केलर", step1Label: "चरण १: लक्ष्य परीक्षा छान्नुहोस्",
        chooseCountry: "१. देश छान्नुहोस्:", allCountries: "🌐 सबै देशहरू", indiaExams: "🇮🇳 भारत परीक्षाहरू", nepalExams: "🇳🇵 नेपाल परीक्षाहरू", usaExams: "🇺🇸 अमेरिका र ग्लोबल",
        filterCategory: "२. श्रेणी अनुसार छान्नुहोस्:", allCat: "सबै श्रेणीहरू", govJobs: "सरकारी जागिर", civilServices: "निजामती / लोक सेवा", banking: "बैंकिङ परीक्षाहरू", medical: "मेडिकल प्रवेश", engineering: "इन्जिनियरिङ प्रवेश",
        tabPhoto: "पासपोर्ट फोटो", tabSig: "दस्तखत अपलोड", btnRemoveBg: "ब्याकग्राउन्ड हटाउनुहोस्", btnDownloadBg: "फोटो डाउनलोड गर्नुहोस्", btnDownloadComp: "कम्प्रेस फोटो डाउनलोड", btnDownloadResize: "रिसाइज फोटो डाउनलोड", btnDownloadConv: "कन्भर्ट फोटो डाउनलोड", btnDownloadCrop: "क्रप फोटो डाउनलोड", btnDownloadUpscale: "4K फोटो डाउनलोड",
        footerHome: "गृहपृष्ठ", footerAbout: "हाम्रो बारेमा", footerReviews: "समीक्षाहरू", footerPrivacy: "गोपनीयता नीति", footerTerms: "सेवाका शर्तहरू", footerContact: "सम्पर्क"
    },
    bn: {
        reset: "রিসেট", reviews: "রিভিউ (4.9⭐)", specsGuide: "গাইড",
        tabExamStudio: "পরীক্ষা স্টুডিও", tabBgRemover: "ব্যাকগ্রাউন্ড রিমুভার", tabCompressor: "ইমেজ কমপ্রেসর",
        tabResizer: "রিসাইজ করুন", tabConverter: "PNG ↔ JPG", tabCropper: "ক্রপ করুন",
        tabPdfToImage: "পিডিএফ থেকে ছবি", tabUpscaler: "4K আপস্কেলার", step1Label: "ধাপ ১: পরীক্ষা নির্বাচন করুন",
        chooseCountry: "১. দেশ নির্বাচন করুন:", allCountries: "🌐 সব দেশ", indiaExams: "🇮🇳 ভারত পরীক্ষা", nepalExams: "🇳🇵 নেপাল পরীক্ষা", usaExams: "🇺🇸 ইউএসএ ও গ্লোবাল",
        filterCategory: "২. বিভাগ অনুযায়ী ফিল্টার:", allCat: "সব বিভাগ", govJobs: "সরকারি চাকরি", civilServices: "সিভিল সার্ভিস / PSC", banking: "ব্যাংকিং পরীক্ষা", medical: "মেডিকেল এন্ট্রান্স", engineering: "ইঞ্জিনিয়ারিং এন্ট্রান্স",
        tabPhoto: "পাসপোর্ট ফটো", tabSig: "স্বাক্ষর আপলোড", btnRemoveBg: "ব্যাকগ্রাউন্ড সরান", btnDownloadBg: "ছবি ডাউনলোড করুন", btnDownloadComp: "কমপ্রেস ছবি ডাউনলোড", btnDownloadResize: "রিসাইজ ছবি ডাউনলোড", btnDownloadConv: "কন্ভার্ট ছবি ডাউনলোড", btnDownloadCrop: "ক্রপ ছবি ডাউনলোড", btnDownloadUpscale: "4K ছবি ডাউনলোড",
        footerHome: "হোম", footerAbout: "আমাদের সম্পর্কে", footerReviews: "রিভিউ", footerPrivacy: "গোপনীয়তা নীতি", footerTerms: "শর্তাবলী", footerContact: "যোগাযোগ"
    },
    ta: {
        reset: "மீட்டமை", reviews: "மதிப்புரைகள் (4.9⭐)", specsGuide: "வழிகாட்டி",
        tabExamStudio: "தேர்வு ஸ்டுடியோ", tabBgRemover: "பின்புலம் நீக்கி", tabCompressor: "அளவு குறைப்பி",
        tabResizer: "அளவு மாற்றி", tabConverter: "PNG ↔ JPG", tabCropper: "பயிர் செய்",
        tabPdfToImage: "PDF to Image", tabUpscaler: "4K அப்ஸ்கேலர்", step1Label: "படி 1: தேர்வை தேர்ந்தெடுக்கவும்",
        chooseCountry: "1. நாட்டைத் தேர்ந்தெடுக்கவும்:", allCountries: "🌐 அனைத்து நாடுகளும்", indiaExams: "🇮🇳 இந்தியா தேர்வுகள்", nepalExams: "🇳🇵 நேபாள தேர்வுகள்", usaExams: "🇺🇸 அமெரிக்கா",
        filterCategory: "2. வகை வாரியாக வடிகட்டவும்:", allCat: "அனைத்து பிரிவுகளும்", govJobs: "அரசு வேலைகள்", civilServices: "சிவில் சர்வீசஸ்", banking: "வங்கி தேர்வுகள்", medical: "மருத்துவ சேர்க்கை", engineering: "பொறியியல் சேர்க்கை",
        tabPhoto: "பாஸ்போர்ட் புகைப்படம்", tabSig: "கையொப்பம் பதிவேற்றம்", btnRemoveBg: "பின்புலம் நீக்கு", btnDownloadBg: "புகைப்படம் பதிவிறக்கு", btnDownloadComp: "அளவு குறைத்த படம் பதிவிறக்கு", btnDownloadResize: "அளவு மாற்றிய படம் பதிவிறக்கு", btnDownloadConv: "மாற்றிய கோப்பு பதிவிறக்கு", btnDownloadCrop: "பயிர்த்த படம் பதிவிறக்கு", btnDownloadUpscale: "4K படம் பதிவிறக்கு",
        footerHome: "முகப்பு", footerAbout: "எங்களைப் பற்றி", footerReviews: "மதிப்புரைகள்", footerPrivacy: "தனியுரிமைக் கொள்கை", footerTerms: "சேவை விதிமுறைகள்", footerContact: "தொடர்பு கொள்ள"
    },
    te: {
        reset: "రీసెట్", reviews: "సమీక్షలు (4.9⭐)", specsGuide: "గైడ్",
        tabExamStudio: "పరీక్ష స్టూడియో", tabBgRemover: "BG రిమూవర్", tabCompressor: "ఇమేజ్ కంప్రెసర్",
        tabResizer: "రీసైజ్ చేయండి", tabConverter: "PNG ↔ JPG", tabCropper: "క్రాప్ చేయండి",
        tabPdfToImage: "PDF నుండి ఇమేజ్", tabUpscaler: "4K అప్‌స్కేలర్", step1Label: "దశ 1: పరీక్షను ఎంచుకోండి",
        chooseCountry: "1. దేశాన్ని ఎంచుకోండి:", allCountries: "🌐 అన్ని దేశాలు", indiaExams: "🇮🇳 ఇండియా పరీక్షలు", nepalExams: "🇳🇵 నేపాల్ పరీక్షలు", usaExams: "🇺🇸 యూఎస్ఏ",
        filterCategory: "2. కేటగిరీ ద్వారా ఫిల్టర్ చేయండి:", allCat: "అన్ని కేటగిరీలు", govJobs: "ప్రభుత్వ ఉద్యోగాలు", civilServices: "సివిల్ సర్వీసెస్", banking: "బ్యాంకింగ్ పరీక్షలు", medical: "మెడికల్ ప్రవేశం", engineering: "ఇంజనీరింగ్ ప్రవేశం",
        tabPhoto: "పాస్‌పోర్ట్ ఫోటో", tabSig: "సంతకం అప్‌లోడ్", btnRemoveBg: "బ్యాక్‌గ్రౌండ్ తీసివేయి", btnDownloadBg: "ఫోటో డౌన్‌లోడ్", btnDownloadComp: "కంప్రెస్ ఫోటో డౌన్‌లోడ్", btnDownloadResize: "రీసైజ్ ఫోటో డౌన్‌లోడ్", btnDownloadConv: "కన్వర్ట్ ఫోటో డౌన్‌లోడ్", btnDownloadCrop: "క్రాప్ ఫోటో డౌన్‌లోడ్", btnDownloadUpscale: "4K ఫోటో డౌన్‌లోడ్",
        footerHome: "హోమ్", footerAbout: "మా గురించి", footerReviews: "సమీక్షలు", footerPrivacy: "గోప్యతా విధానం", footerTerms: "సేవా నిబంధనలు", footerContact: "సంప్రదించండి"
    },
    es: {
        reset: "Restablecer", reviews: "Reseñas (4.9⭐)", specsGuide: "Guía de Especificaciones",
        tabExamStudio: "Estudio de Examen", tabBgRemover: "Quitar Fondo", tabCompressor: "Compresor de Imagen",
        tabResizer: "Redimensionar", tabConverter: "PNG ↔ JPG", tabCropper: "Recortar Imagen",
        tabPdfToImage: "PDF a Imagen", tabUpscaler: "Escalador 4K", step1Label: "Paso 1: Seleccionar Examen Objetivo",
        chooseCountry: "1. Elegir País:", allCountries: "🌐 Todos los Países", indiaExams: "🇮🇳 Exámenes India", nepalExams: "🇳🇵 Exámenes Nepal", usaExams: "🇺🇸 EE.UU. y Global",
        filterCategory: "2. Filtrar por Categoría:", allCat: "Todas las Categorías", govJobs: "Empleos Gubernamentales", civilServices: "Servicio Civil / PSC", banking: "Exámenes Bancarios", medical: "Entrada Médica", engineering: "Entrada Ingeniería",
        tabPhoto: "Foto de Pasaporte", tabSig: "Firma Digital", btnRemoveBg: "Eliminar Fondo", btnDownloadBg: "Descargar Imagen", btnDownloadComp: "Descargar Imagen Comprimida", btnDownloadResize: "Descargar Imagen Redimensionada", btnDownloadConv: "Descargar Archivo Convertido", btnDownloadCrop: "Descargar Imagen Recortada", btnDownloadUpscale: "Descargar Imagen 4K",
        footerHome: "Inicio", footerAbout: "Sobre Nosotros", footerReviews: "Reseñas", footerPrivacy: "Política de Privacidad", footerTerms: "Términos de Servicio", footerContact: "Contacto"
    },
    fr: {
        reset: "Réinitialiser", reviews: "Avis (4.9⭐)", specsGuide: "Guide des Spécifications",
        tabExamStudio: "Studio Examen", tabBgRemover: "Effacer Fond", tabCompressor: "Compresseur d'Image",
        tabResizer: "Redimensionner", tabConverter: "PNG ↔ JPG", tabCropper: "Rogner L'Image",
        tabPdfToImage: "PDF en Image", tabUpscaler: "Agrandir en 4K", step1Label: "Étape 1: Sélectionner L'Examen Cible",
        chooseCountry: "1. Choisir le Pays:", allCountries: "🌐 Tous les Pays", indiaExams: "🇮🇳 Examens Inde", nepalExams: "🇳🇵 Examens Népal", usaExams: "🇺🇸 É-U et Mondial",
        filterCategory: "2. Filtrer par Catégorie:", allCat: "Toutes les Catégories", govJobs: "Emplois Publics", civilServices: "Fonction Publique", banking: "Examens Bancaires", medical: "Entrée Médicale", engineering: "Entrée Ingénierie",
        tabPhoto: "Photo de Passeport", tabSig: "Signature", btnRemoveBg: "Supprimer le fond", btnDownloadBg: "Télécharger l'image", btnDownloadComp: "Télécharger l'image compressée", btnDownloadResize: "Télécharger l'image redimensionnée", btnDownloadConv: "Télécharger le fichier converti", btnDownloadCrop: "Télécharger l'image rognée", btnDownloadUpscale: "Télécharger l'image 4K",
        footerHome: "Accueil", footerAbout: "À Propos", footerReviews: "Avis", footerPrivacy: "Politique de Confidentialité", footerTerms: "Conditions d'Utilisation", footerContact: "Contact"
    },
    ar: {
        reset: "إعادة ضبط", reviews: "التقييمات (4.9⭐)", specsGuide: "دليل المواصفات",
        tabExamStudio: "استوديو الامتحانات", tabBgRemover: "إزالة الخلفية", tabCompressor: "ضغط الصور",
        tabResizer: "تغيير الحجم", tabConverter: "PNG ↔ JPG", tabCropper: "قص الصور",
        tabPdfToImage: "تحويل PDF لصور", tabUpscaler: "مكبر 4K", step1Label: "الخطوة 1: اختر الامتحان المستهدف",
        chooseCountry: "1. اختر الدولة:", allCountries: "🌐 جميع الدول", indiaExams: "🇮🇳 امتحانات الهند", nepalExams: "🇳🇵 امتحانات نيبال", usaExams: "🇺🇸 أمريكا والعالم",
        filterCategory: "2. التصفية حسب الفئة:", allCat: "جميع الفئات", govJobs: "وظائف حكومية", civilServices: "الخدمة المدنية", banking: "الامتحانات المصرفية", medical: "القبول الطبي", engineering: "قبول الهندسة",
        tabPhoto: "صورة جواز السفر", tabSig: "التوقيع", btnRemoveBg: "إزالة الخلفية", btnDownloadBg: "تحميل الصورة النظيفة", btnDownloadComp: "تحميل الصورة المضغوطة", btnDownloadResize: "تحميل الصورة المعدلة", btnDownloadConv: "تحميل الملف المحول", btnDownloadCrop: "تحميل الصورة المقصوصة", btnDownloadUpscale: "تحميل صورة 4K",
        footerHome: "الرئيسية", footerAbout: "من نحن", footerReviews: "التقييمات", footerPrivacy: "سياسة الخصوصية", footerTerms: "شروط الخدمة", footerContact: "اتصل بنا"
    }
};
